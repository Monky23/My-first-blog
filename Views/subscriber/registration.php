...
<div class="registration-form">
    ...
    <form action="/registration" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="username" id="username" class="form-control" placeholder="Pseudo *" required="required" autocomplete="off">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="phone_number" id="phone_number" class="form-control" placeholder="Numéro de téléphone" autocomplete="off">
        </div>
        <div class="form-group">
        ...
        <div class="mb-3  form-group">
            ...
            <label for="ft_image" class="form-label">photo de profil</label>
